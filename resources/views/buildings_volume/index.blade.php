	...
	<div id="panel-1" class="panel">
		<div class="panel-hdr">
			<div class="panel-content table-responsive">
				<h5>Data Totals on Buildings Volume Page</h5>
			</div>
		</div><!--end panel-hdr-->
					...
					<div class="panel-content table-responsive">
						<table id="dt-basic-example" class="table table-bordered table-hover table-striped w-100">
							<tr>
								...
								<td id="consBlk" name="consBlk">xxx</td>
							</tr>
							<tr>
								<td>Budgeted:
								</td>
								<td id="bgtBlk">xxxx</td>
							</tr>
							<tr>
								<td>Projected:
								</td>
...
<main id="js-page-content" >
	<div class="panel-container show">
					<div class="panel-content table-responsive">
						<div class="panel-tag">
							This table shows volumes by building.
						</div>
					...
					<div class="btn-group my-3">			
						<a href="index" class="btn btn-sm btn-primary center mx-3">A Button</a>
						<a href="index" class="btn btn-sm btn-primary center">Another Button</a>			
					</div><!--end form-group-->
